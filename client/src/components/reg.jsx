...
export default function Example() {
  return (
    <form>
      <div className="space-y-12 p-4 shadow-lg shadow-red-900">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              <label htmlFor="Tournament Name" className="block text-sm font-medium leading-6 text-gray-900">
              Tournament Name
              </label>
              <div className="mt-2">
                <input
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            We'll always notify Email . please click the button below .
          </p>
